...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        classic_meet = CarMeet(name="Manny's Muscle Meet",type="Muscle",start_date="start",end_date="end",tier_1_tickets=3,tier_2_tickets=3,tier_3_tickets=3)
        super_meet = CarMeet(name="Sammy's Super Meet",type="Super",start_date="start",end_date="end",tier_1_tickets=3,tier_2_tickets=3,tier_3_tickets=3)
        muscle_meet =  CarMeet(name="Tammy's Truck Meet",type="Truck",start_date="start",end_date="end",tier_1_tickets=3,tier_2_tickets=3,tier_3_tickets=3)
